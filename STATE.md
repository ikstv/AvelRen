...
| Branch | Ahead | Behind |
|---|---|---|
| `chore/neutralize-public` | 2 | 6 |
| `chore/repo-tidy` | 2 | 10 |
| `chore/state-refresh` | 3 | 2 |
...
| `dependabot/github_actions/actions-a10aefb1c3` | 1 | 4 |
| `docs/readme-badges-index-diagram-119` | 1 | 0 |
| `docs/readme-professional` | 1 | 65 |
| `docs/signal-has-a-date` | 1 | 14 |
| `feat/launcher-road-a` | 1 | 7 |
| `feat/privacy-page` | 3 | 9 |
| `feat/ratelimit-coverage-and-least-privilege-role-tests` | 1 | 2 |
| `feat/source-attribution` | 2 | 4 |
| `feat/truthful-server-badge` | 1 | 4 |
| `fix/alert-channel-gate-113` | 2 | 0 |
| `fix/background-delivery-hint-117` | 1 | 0 |
| `fix/backup-future-objects-end-state-contract` | 1 | 1 |
| `fix/backup-grants-and-rate-limits` | 1 | 1 |
| `fix/backup-rclone-token-write` | 2 | 0 |
| `fix/ci-silent-gates` | 1 | 3 |
| `fix/collector-runs-error-91` | 1 | 11 |
| `fix/db-readiness-tcp-probe-146` | 1 | 0 |
| `fix/eta-contamination-127` | 1 | 0 |
| `fix/history-clean-hourly-111` | 1 | 0 |
| `fix/onboarding-bg-and-asset-provenance` | 1 | 5 |
