...
/**
 * Видима атрибуція джерела держданих — частина вимог Google Play (Misleading
 * Claims). Її достатньо показувати в основному контексті, де користувач бачить
 * дані черг; не дублюємо її в службових діалогах і picker-екранах.
 *
