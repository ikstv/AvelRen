...
bring-up, CI parity) lives in the private ops repo `AvelRen-ops`, together with
audits, prod runbooks, and the upstream integration contract — it names
production specifics that do not belong in a public repo.
